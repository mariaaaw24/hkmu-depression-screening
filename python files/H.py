...
#LOAD DATASETS
def load_data():
    train_f = pd.read_excel('features/H_test_103_02_180_7_60_trainFM.xls', header=None)
    test_f = pd.read_excel('features/H_test_103_02_180_7_60_testFM.xls', header=None)
