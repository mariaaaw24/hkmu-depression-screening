...
#LOAD DATASET
def load_data():
    train_f = pd.read_excel('features/E_test_112_02_180_11_60_trainFM.xls', header=None)
    test_f = pd.read_excel('features/E_test_112_02_180_11_60_testFM.xls', header=None)
