...
#LOAD DATASETS
def load_data():
    train_f = pd.read_excel('features/E120220t_training_feature_matrix.xls', header=None)
    test_f = pd.read_excel('features/E120220t_testing_feature_matrix.xls', header=None)
