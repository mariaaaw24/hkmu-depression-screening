...
#Load datasets
def load_data():
    train_f = pd.read_excel('features/BE_test_14_02_180_11_40_trainFM.xls', header=None)
    test_f = pd.read_excel('features/BE_test_14_02_180_11_40_testFM.xls', header=None)
...
if __name__ == "__main__":
    ...
    grid_search = GridSearchCV(XGBClassifier(eval_metric='logloss'), param_grid, scoring='accuracy', cv=cv, n_jobs=-1)
