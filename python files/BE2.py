...
#LOAD DATASET
def load_data():
    train_f = pd.read_excel('features/BE_dev_31_02_180_7_40_trainFM.xls', header=None)
    develop_f = pd.read_excel('features/BE_dev_31_02_180_7_40_testFM.xls', header=None)
